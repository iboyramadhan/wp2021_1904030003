...
<body>
  ...
  <div class="jumbotron jumbotron-fluid text-center">
    <div class="container">
      <h1 class="display-4"><span class="font-weight-bold">Ilham Restaurant</span></h1>
      <hr>
      <p class="lead font-weight-bold"> Cari Makanan Jepang ? Cek aja Di sini </p>
    </div>
  </div>
  <!-- Akhir Jumbotron -->
  ...
  <div class="container">
    <div class="judul text-center mt-2">
      <h3 class="font-weight-bold">Ilham Restaurant</h3>
      <h5>Jl. Maulana Yusuf 15114 Tangerang banten · 21,22 km
        <br>Buka Jam <strong>15:00 - 21:00</strong>
      </h5>
    </div>
